...
const host = process.env.HOST || "192.168.0.200:4000";
...
http://${host}/api/v1/auth/verify?token=${token._id}&code=${token.code} (link is valid for 24 hours)
...
http://${host}/api/v1/auth/reset-password?token=${token._id}&code=${token.code} (link is valid for 24 hours)
